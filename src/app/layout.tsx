  ...
  return (
    <html lang="en">
      <body className={`bg-smoky-black ${poppins.variable}`}>
        <main className="my-[60px] me-auto ms-auto flex w-[95%] max-w-[1200px] flex-col flex-wrap content-center justify-center gap-8 font-poppins md:w-[750px] lg:w-[950px] xl:flex xl:w-auto xl:flex-row">
          <Sidebar />
